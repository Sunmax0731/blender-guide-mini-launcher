...
- 作業ディレクトリ: `D:\AI\BlenderAddon\blender-guide-mini-launcher`
...
2. `npm run validate` を実行し、`dist/blender-guide-mini-launcher-representative-report.json` が生成されることを確認する。
